  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Fill out as much detail as possible to help others understand your project.
        </Typography>
        ...
        >
          ...
          <FormControl fullWidth>
            <InputLabel>What are somes tags your would associate with your project idea?*</InputLabel>
            <Select
              multiple
              ...
              variant="outlined"
            >
              {["Computer Science (CS)", "Social Sciences (SS)", "Arts and Humanities (AH)", "Natural Sciences (NS)"].map((major) => (
        ...
        <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
          <GradientButton onClick={handleSaveDraft} content="Save the draft" className="w-1/2"/>
          <Link href="#" underline="hover" sx={{ marginTop: "16px", color: "#6C6C80" }}>
            Go back
          </Link>
        </Box>
      </Container>
